function loadPage1() {
    document.getElementById('about-me').innerHTML = '<div id="text-container">' +
        ...
        '<button onclick="loadPage2()">Cultural Experience</button>' +
        
        '<button onclick="loadPage3()">Back to About Me </button>' + 
...
function loadPage2() {
    document.getElementById('about-me').innerHTML = '<div id="text-container">' +
        ...
        '<button onclick="loadPage1()">Professional Experience</button>' + '<button onclick="loadPage3()">Back to About Me</button>' +
                ...
                <div class="ajustador-2">
                    <div class="about-menu">
                        ...
                        <div class="about-content">
                            ...
                            <div class="centered-buttons">
                                <button onclick="loadPage1()">Professional Experience</button>
                                <button onclick="loadPage2()">Cultural Experience</button>
                            </div>
                        </div>
                    </div>
